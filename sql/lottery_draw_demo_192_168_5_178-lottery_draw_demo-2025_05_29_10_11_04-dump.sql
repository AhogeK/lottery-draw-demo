...
--
-- Host: 192.168.5.178    Database: lottery_draw_demo
-- ------------------------------------------------------
...
--
-- Table structure for table `self_chosen_winning`
--

DROP TABLE IF EXISTS `self_chosen_winning`;
/*!40101 SET @saved_cs_client = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `self_chosen_winning`
(
    `id`          bigint unsigned  NOT NULL AUTO_INCREMENT,
    `winning_id`  bigint unsigned  NOT NULL COMMENT '中奖单个号码id',
  ...
  AUTO_INCREMENT = 37
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='自选中奖';
/*!40101 SET character_set_client = @saved_cs_client */;
